...
const UpcomingAppointments = () => {
    ...
    const { cartData, refetch, isPending, error } = UseCartData();
    ...
    return (
        <div>
            <div className="overflow-x-auto font-[sans-serif] my-10">
                <table className="min-w-full bg-white">
                    ...
                    <tbody className="whitespace-nowrap divide-y divide-gray-200">
                        ...
                        {
                            cartData.map(item =>
                                <tr key={item._id} className="transition duration-500 shadow ease-in-out transform hover:-translate-y-1 hover:shadow-lg select-none cursor-pointer mb-4">
                                    <td className="p-4 text-sm">
                                        <div className="flex items-center cursor-pointer w-max">
                                            <div className="ml-4">
                                                <p className="text-sm text-black">{item.slotDate}</p>
                                    ...
                                    <td className="px-6 py-3">
                                        ...
                                        <button onClick={() => removeItem(item._id)} className="mr-4" title="Delete">
