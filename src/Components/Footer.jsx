                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-300 text-sm">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae optio quia labore ad deleniti quae fugiat commodi, nihil corporis nulla itaque sint corrupti ipsa adipisci facilis? Expedita qui id assumenda?
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <p className="text-gray-300 text-sm">123 Street, Dhaka</p>
                            <p className="text-gray-300 text-sm">sakhawat.code.info@gmail.com</p>
                            <p className="text-gray-300 text-sm">+88 01939-727303</p>
                        </div>
                    </div>
