                ...
                <div className='flex flex-wrap items-center justify-between px-10 py-3 gap-4 w-full'>
                    ...
                    <div id="collapseMenu"
                        ...
                        <ul
                            ...
                            <li className='max-lg:border-b max-lg:py-3'>
                                <NavLink to={'/registration'} className={({ isActive }) => isActive ? "hover:text-blue-600 text-[15px] font-bold text-blue-600 block" : "hover:text-[#007bff] text-gray-600 text-[15px] font-bold block"}>
                    ...
                    <div className='flex items-center space-x-8 max-lg:ml-auto'>
                        ...
                        <button className='group max-lg:border-b max-lg:py-3 relative '>
                            <a href='javascript:void(0)'
                                className='hover:text-[#007bff] text-gray-600 text-[15px] font-bold lg:hover:fill-[#007bff] block'>
                                <img className="w-6 h-6 rounded-lg" src="https://lh3.googleusercontent.com/a/AGNmyxbSlMgTRzE3_SMIxpDAhpNad-_CN5_tmph1NQ1KhA=s96-c" alt="" />
                                <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" className="ml-1 inline-block"
                                    viewBox="0 0 24 24">
                                    <path
