    ...
    return (
        <div>
            ...
            <header className='flex border-b bg-white font-sans min-h-[70px] tracking-wide relative z-50'>
                <div className='flex flex-wrap items-center justify-between px-4 py-3 gap-4 w-full'>
                    <Link to={'/'} className="flex items-center gap-1">
                        <img src={logo} alt="logo" className='w-14' />
                        <h2 className="text-xl font-extrabold text-[#333] inline-block">Revival Hospital</h2>
                    </Link>
                    ...
                    <div id="collapseMenu"
                        ...
                        <ul
                            ...
                            {/* navbar all items here  */}

                            <li className='max-lg:border-b max-lg:py-3'>
                                <NavLink to={'/'} className={({ isActive }) => isActive ? "hover:text-blue-600 text-[15px] font-bold text-blue-600 block" : "hover:text-[#007bff] text-gray-600 text-[15px] font-bold block"}>
                                    Home
                                </NavLink>
                            </li>
                            <li className='max-lg:border-b max-lg:py-3'>
                                ...
                                user && <>
                                    ...
                                    <li className='max-lg:border-b max-lg:py-3'>
                                        <span className="relative">
                                            ...
                                            <span className="absolute left-auto -ml-1 -top-1 rounded-full bg-red-500 px-1 py-0 text-xs text-white">{cartData.length}</span>
                                        </span>
                                    </li>
                            ...
                            {/* <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                                className='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'>Team</a>
                            </li> */}
                    ...
                    <div className='flex items-center space-x-8 max-lg:ml-auto'>
...

                        {
                            user ? <>
                                ...
                                <Link to={'/adminDashboard'} className="relative px-4 py-2 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group">
                                    ...
                                    <span className="relative transition-colors duration-300 delay-200 group-hover:text-white ease">Admin</span>
                                </Link>



                                <button title={user.displayName} className='group max-lg:border-b max-lg:py-3 relative '>
                                    <a href='javascript:void(0)'
                                        className='hover:text-[#007bff] text-gray-600 text-[15px] font-bold lg:hover:fill-[#007bff] block'>
                                        <img className="w-6 h-6 rounded-lg" src={user.photoURL} alt="" />
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" className="ml-1 inline-block"
                                            viewBox="0 0 24 24">
                                            <path
                                    ...
                                    <ul
                                        className='absolute shadow-lg bg-white space-y-3 lg:top-10 max-lg:top-8 -right-6 min-w-60  z-50 max-h-0 overflow-hidden group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500'>
                                        {/* 
