    ...
    const handleDeleteTestData = (deletedID) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const deleteOk = await axiosSecure.delete(`/testDataDelete/${deletedID}`);
                                ...
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead className="bg-gray-50 dark:bg-gray-800">
                                        <tr>
                                            ...
                                            <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Booked Test</th>
                                            ...
                                            allTest?.map((item, index = 1) => <tr key={item._id}>
                                                ...
                                                <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div className="flex items-center gap-x-6">
                                                        <button onClick={() => handleDeleteTestData(item._id)} className="text-gray-500 transition-colors duration-200 dark:hover:text-red-500 dark:text-gray-300 hover:text-red-500 focus:outline-none">
