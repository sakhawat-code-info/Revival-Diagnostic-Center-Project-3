                        ...
                        <tr className="hover:bg-gray-50">
                            ...
                            <td className="p-4 text-sm text-black">
                                <div className="flex items-center cursor-pointer w-max">
                                    ...
                                    <div className="ml-4">
                                        <p className="text-sm text-black">FBS bannerName</p>
                                        <p className="text-xs text-gray-500 mt-1">Blood Catagory bannerTitle</p>
                                    </div>
                                </div>
                            </td>
                            <td className="p-4 text-sm text-black">
                            ...
                            <td className="p-4 text-sm text-black">
                                470 tk (15%) bannerCouponRate
                                <p className="text-xs text-gray-500 mt-1">550 tk bannerActualRate</p>
                            </td>
                            <td className="p-4 text-sm text-green-700 font-extrabold text-center">
                                {/* bannerIsActive */}
                                <span
                                    className="w-[68px] block text-center py-1 border border-green-500 text-green-600 rounded text-xs mb-1">Active</span>
                                <span
                                    className="w-[68px] block text-center py-1 border border-yellow-500 text-yellow-600 rounded text-xs">Inactive</span>

                                {/* <p className="text-xs text-gray-500 mt-1">Web UI/UX Design</p> */}
                            </td>
                            <td className="p-4 text-sm text-black">
                                <div className="flex flex-col">
                                    <Link to={'/adminDashboard/bannerDataUpdate'}
